        ...
        if(count($errors) == 0){
            ...
            $sql = "INSERT INTO user (username, email, Fname, Lname, password) 
                ...
                if(!mysqli_stmt_prepare($stmt, $sql)){
                    ...
                    mysqli_stmt_bind_param($stmt, "sssss", $_POST['user'], $_POST['email'], $_POST['fname'], $_POST['lname'], (password_hash($_POST['pass1'], PASSWORD_DEFAULT)));
            ...
            if(!mysqli_stmt_prepare($stmt, $query)){
                ...
                $isCorrect=password_verify($_POST['pass'], $accountPass);
                    if ($isCorrect == 1){
                        ...
                        //$_SESSION['loggedin'] = true;
                        /*$_SESSION['username'] = $_POST['user'];
                        $query = "SELECT user_id FROM user WHERE username = '".$_SESSION['username']."'";
